      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <section className="pt-10 pb-8 text-center md:text-left">
          <div className="flex items-center gap-2 justify-center md:justify-start mb-2">
            ...
            <span className="text-xs font-medium text-indigo-600 uppercase tracking-wider">每周持续更新</span>
          </div>
          ...
          <div className="glass-card rounded-2xl p-4 md:p-5 flex flex-col gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 rounded-xl text-sm bg-white/60 border border-white/50 placeholder:text-gray-400 text-gray-700 outline-none focus:ring-2 focus:ring-indigo-200/60 focus:border-indigo-300/50 transition-all backdrop-blur-sm"
              />
            </div>
            ...
            <div className="flex items-start gap-3 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-full text-sm glass-card border border-white/40 text-gray-600 hover:text-gray-900 transition-all"
              >
